    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_name', models.CharField(max_length=20)),
                ('public_name', models.CharField(max_length=80)),
                ('value', models.IntegerField(default=0, help_text='Para ordenar y decidir según menor')),
                ('description', models.TextField(blank=True, null=True)),
                ...
                ('transparency_index', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='levels', to='transparency.transparencyindex', verbose_name='Indicador de Transparencia')),
            ],
            options={
