...
class GroupFile(models.Model):
    ...
    need_partition = models.BooleanField(default= False)
    need_transform = models.BooleanField(default= False) ##

    def __str__(self):
        return self.name

    class Meta:
        verbose_name = u"Archivo de grupos"
        verbose_name_plural = u"Archivo de grupos"
...
class MissingRows(models.Model):
    ...
    class Meta:
        verbose_name = u"Renglon faltante"
