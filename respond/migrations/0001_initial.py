    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(max_length=255, upload_to=respond.models.set_upload_data_file_path)),
                ('is_duplicated', models.BooleanField(blank=True, null=True, verbose_name='Duplicado')),
                ...
                ('sample_file', models.FileField(blank=True, max_length=255, null=True, upload_to=respond.models.set_upload_data_file_path, verbose_name='Archivo con muestra')),
                ...
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='data_files', to='geo.provider')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(max_length=255, upload_to=respond.models.set_upload_sheet_file_path)),
                ...
                ('sample_file', models.FileField(blank=True, max_length=255, null=True, upload_to=respond.models.set_upload_sheet_file_path, verbose_name='Archivo con muestra')),
                ('total_rows', models.IntegerField(default=0)),
                ...
                ('month_records', models.ManyToManyField(blank=True, related_name='sheet_files', to='inai.monthrecord')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(blank=True, max_length=255, null=True, upload_to=respond.models.set_upload_reply_path, verbose_name='archivo')),
                ('date', models.DateTimeField(auto_now_add=True)),
                ...
                ('month_records', models.ManyToManyField(blank=True, related_name='reply_files', to='inai.monthrecord')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('month_record', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='crossing_sheets', to='inai.monthrecord')),
                ...
                ('week_record', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='crossing_sheets', to='inai.weekrecord')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(max_length=255, upload_to=respond.models.set_upload_table_file_path)),
                ...
                ('provider', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='table_files', to='geo.provider')),
                ('week_record', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='table_files', to='inai.weekrecord')),
            ],
            options={
