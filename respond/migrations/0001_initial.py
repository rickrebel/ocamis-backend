    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample_file', models.FileField(blank=True, max_length=255, null=True, upload_to=inai.models.set_upload_path, verbose_name='Archivo con muestra')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(blank=True, max_length=255, null=True, upload_to=inai.models.set_upload_path, verbose_name='archivo')),
                ('date', models.DateTimeField(auto_now_add=True)),
